        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <input type="hidden" name="syga_rating_input[<?php echo $position; ?>][values]" id="syga_rating_input[<?php echo $position; ?>][values]" value="<?php echo $this->syhelpers::_serialize($rate['values']); ?>">
                </tr>
            </tbody>
        </table>
    </div>
